          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-7 gap-6">
            {categories.slice(1).map((category) => (
              <Link
                ...
                className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-all hover:-translate-y-1 text-center flex flex-col items-center"
              >
          ...
          <div className="text-center">
            ...
            <form className="flex flex-col sm:flex-row gap-4 max-w-2xl mx-auto">
              <input
                ...
                className="flex-grow px-6 py-4 rounded-lg focus:ring-secondary focus:border-secondary text-gray-800"
                required
              />
              <Button type="submit" className="bg-secondary hover:bg-secondary/90 text-white px-8 py-4">
                Subscribe
              </Button>
            </form>
          </div>
