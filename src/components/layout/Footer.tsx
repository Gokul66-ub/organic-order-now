    ...
    <footer className="bg-gray-100 pt-10 pb-5">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Information */}
          <div>
            <h3 className="text-lg font-semibold text-gray-800 mb-4">🥕 Fresh Mart</h3>
            <p className="text-gray-600 mb-4">
              Delivering fresh, organic groceries right to your doorstep.
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/shipping" className="text-gray-600 hover:text-primary">Shipping Information</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">Get updates on new products and seasonal specials.</p>
